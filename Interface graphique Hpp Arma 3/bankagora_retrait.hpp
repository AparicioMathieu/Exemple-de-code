class Life_atm_management_new_retrait {
	idd = 27003;
	name= "life_atm_menu_retrait";
	movingEnable = false;
	enableSimulation = true;
	onLoad="[] spawn ATM_fnc_retrait;";	
	...
	class controls {
		...
		class Retrait_Gang : Life_RscTitle {
			idc = 45095;
			text = "Effectuer un retrait";
			x = 0.02;
      		y = 0.61;
		...
		class Retrait_Gang_suite : Life_RscTitle {
			idc = 45096;
			text = "sur le compte gendarme";
			x = 0.02;
      		y = 0.65;
      		w = 0.65;
    		h = 0.05;
		...
		class Retrait_Gang_Inv : Life_RscButtonInvisible { 
			idc = 45097;
			onButtonClick = "closeDialog 0; [] spawn life_fnc_atmMenuGendarme;";			
			x = 0.26;
      		y = 0.61;
      		w = 0.10;
      		h = 0.05;	
