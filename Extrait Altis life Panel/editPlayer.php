...
?>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  ...
		  <p class="page-header">Modifier le menu du lecteur du panel, vous permet de modifier les valeurs plus en profondeur.</p>
          ...
          <div class="btn-group" role="group" aria-label="...">
          <button type="button" class="btn btn-primary btn-outline" data-toggle="modal" data-target="#myModal">Player Inventaire</button>
          </form>
    </div>
          <br>
...
<div class="modal-dialog modal-lg">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title" id="myModalLabel">Player Inventaire</h4>
    </div>
    <div class="modal-body">

        <div class='panel panel-info'>
            <div class='panel-heading'>
                <h3 class='panel-title'>Civilian Inventaire</h3>
            </div>
        ...
        <div class='panel panel-info'>
            <div class='panel-heading'>
                <h3 class='panel-title'>Cop Inventaire</h3>
            </div>
            <div class='panel-body'>
        ...
        <div class='panel panel-info'>
            <div class='panel-heading'>
                <h3 class='panel-title'>Medic Inventaire</h3>
            </div>
            <div class='panel-body'>
