...
// Importataiton de script
<script src="scripts/jquery-1.12.3.min.js"></script>
<script src="scripts/jquery.backstretch.js"></script>
<script>if (window.module) module = window.module;</script>

//Script qui gére le temps de connection
<script> 
function startTime() {
    var today = new Date();
...
if (isset($_COOKIE['conecFail']) && $_COOKIE['conecFail'] == '1') {
    echo'<div style="color:red"><center>La connexion a la database est impossible</center></div>';
}

if (isset($_COOKIE['fail']) && $_COOKIE['fail'] == '1') {
    echo'<div style="color:red"><center>Login incorrect</center></div>';
}
?>
